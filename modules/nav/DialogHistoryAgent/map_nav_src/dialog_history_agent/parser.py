...
def parse_args():
    ...
    # General
    parser.add_argument('--iters', type=int, default=6250, help='training iterations')
    ...
    parser.add_argument("--aug_episodic_training_times", type=int, default=9)
    ...
    parser.add_argument('--extend_wta', action='store_true', default=False)
    parser.add_argument('--except_train_seen', action='store_true', default=True)
    parser.add_argument('--wta_mode', type=str, default=None)

    parser.add_argument("--mp3d_ft_files", type=str, default='/home/master/00_WorkDir/04_VDNRA/90_datasets/features/clip_vit-h14_mp3d_original.hdf5')
    parser.add_argument("--val_ft_file", type=str, default='/home/master/00_WorkDir/04_VDNRA/90_datasets/features/clip_vit-h14_mp3d_original.hdf5')
    parser.add_argument("--connectivity_dir", type=str, default='/home/master/00_WorkDir/04_VDNRA/90_datasets/connectivity/')

    parser.add_argument('--append_q', action='store_true', default=False)
    ...
    parser.add_argument('--use_nav_turn_path', action='store_true', default=False)

    # parser.add_argument('--wta_weight', type=float, default=10.0)

    parser.add_argument('--maximum_navigation_history_length', type=int, default=50, help='use episodes with history length less than this')
    ...
    parser.add_argument('--multitask_training', action='store_true', default=False)
    parser.add_argument('--multitask_aug_instance_training_times', type=int, default=9)

    parser.add_argument('--question_weight', type=float, default=1.0)
    parser.add_argument('--save_log_every', type=int, default=5)
