...
def parse_args():
    ...
    parser.add_argument('--set_navigation_history', action='store_true', default=False)
    parser.add_argument('--use_dialog_history', action='store_true', default=False)
    ...
    parser.add_argument('--aug_data_dir', type=str, default='A')
