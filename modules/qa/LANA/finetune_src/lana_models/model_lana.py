...
from lana_models.vlnbert_init_lana import get_vlnbert_models
...
class VLNBertCMT(nn.Module):
    ...
    def forward(self, mode, txt_ids=None, txt_masks=None, txt_embeds=None, 
                ...
                ob_position=None, position=None, graph_mask=None,  question_ids=None, answer_ids = None
                ):
        ...
        #         action_embeds=action_embeds, action_masks=action_masks,
        #         ob_embeds=ob_embeds, ob_masks=ob_masks, ob_nav_types=ob_nav_types,
        #         future_mask=future_mask, is_train_caption=is_train_caption, is_train_contrastive=is_train_contrastive, question_ids=question_ids, answer_ids = answer_ids)
        #     return loss
