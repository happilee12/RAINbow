...
def parse_args():
    ...
    parser.add_argument('--connectivity_dir', type=str, default=None)
    parser.add_argument('--valseen_data_path', type=str, default=None)
    parser.add_argument('--valunseen_data_path', type=str, default=None)
    parser.add_argument('--train_data_path', type=str, default=None)
    parser.add_argument('--aug_data_paths', type=str, default=None)
    parser.add_argument('--log_every_epochs', type=int, default=2)
    parser.add_argument('--wandb_log', action='store_true', default=False)
    parser.add_argument('--id', type=str, default=None)
    parser.add_argument('--model_save_path', type=str, default=None)
    parser.add_argument('--debug', action='store_true', default=False)
    # Graph map building options
    parser.add_argument('--graph_maps_save_path', type=str, default=None,
                       help='Path to save the built graph maps')
    
    # GPU 최적화 옵션
    parser.add_argument('--preload_all_features', action='store_true', default=False,
                       help='Preload all features to GPU memory at initialization')
    parser.add_argument('--preload_batch_features', action='store_true', default=True,
                       help='Preload features for batch processing')
    parser.add_argument('--disable_gpu_features', action='store_true', default=False,
                       help='Disable loading features to GPU (use CPU memory only)')

    # neighbor loss
    parser.add_argument('--use_neighbor_loss', action='store_true',
                      help='Whether to use neighboring nodes as soft targets')
    parser.add_argument('--neighbor_loss_weight', type=float, default=0.3,
                      help='Weight for neighboring node loss (default: 0.3)')
       ### debug
    parser.add_argument('--wandb_project', type=str, default='debug')
    parser.add_argument('--log_every_iters', type=int, default=1000)
