...
parser.add_argument("--embedding_dir", type=str, default="./src/cross_moda/")
...
parser.add_argument("--aug_train_files", type=str, default="")
parser.add_argument("--val_seen_file", type=str, default="")
parser.add_argument("--val_unseen_file", type=str, default="")
parser.add_argument("--test_file", type=str, default="")
parser.add_argument("--gcn", default=False, action="store_true")
parser.add_argument("--bert_enc", default=False, action="store_true")
