...
gpus=2
id=duetloc.v4.0.02_ft
basepath=/home/vln/DialNav2
project_path=/home/vln/DialNav2/modules/loc/DuetLoc
output_path=/home/vln/DialNav2_outputs/DuetLoc
CUDA_VISIBLE_DEVICES=$gpus python3 main/main_nav.py $flag  \
      ...
      --eval_first \
      --train \
      --resume_file /home/vln/DialNav2_outputs/DuetLoc/duetLoc.v4.0.01_setratio/latest.pth \
      # --debug \
